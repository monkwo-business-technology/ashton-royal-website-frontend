export const inputBase =
  "w-full rounded-2xl border bg-white/80 px-4 py-3 text-ink outline-none transition placeholder:text-ink-soft/50 focus:ring-4 focus:ring-orange-400/15 dark:bg-white/[0.06]";
